...
spark_distribs[2.4.5]="${HOME}/tools/spark-2.4.5-bin-hadoop2.7"
spark_distribs[2.4.6]="${HOME}/tools/spark-2.4.6-bin-hadoop2.7"
spark_distribs[2.4.7]="${HOME}/tools/spark-2.4.7-bin-hadoop2.7"
...
do
    ...
    testId="test__${sparkVersion}__${hadoopVersion}__${jdkDist}__${pyDist}"
    ...
    spark-shell \
        ...
        --conf spark.args.twitterParquetCommonVersion="${twitterParquetCommonVersion}" \
        --conf spark.args.twitterParquetFormatVersion="${twitterParquetFormatVersion}" \
        --conf spark.args.twitterParquetThriftVersion="${twitterParquetThriftVersion}" \
        --conf spark.args.apacheParquetCommonVersion="${apacheParquetCommonVersion}" \
        --conf spark.args.apacheParquetFormatVersion="${apacheParquetFormatVersion}" \
        --conf spark.args.apacheParquetThriftVersion="${apacheParquetThriftVersion}" \
    < "${HOME}/tests/test-${sparkVersion}-sql.scala" \
    2>&1 \
